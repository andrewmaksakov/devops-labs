...
- [x] Знаю что показывает `lsblk`, `df -h`, `du -sh`
- [x] Могу создать бэкап и показать где он лежит
- [x] Могу проверить размер и содержимое бэкапа
- [x] Могу восстановить конфиги из бэкапа
- [x] Могу объяснить что такое page cache
