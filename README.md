...
- [ ] VM установлена и доступна по SSH
- [ ] SSH по ключам работает
- [ ] `collect_sysinfo.sh` написан и работает
- [ ] `log_grep.sh` написан и работает
- [ ] `troubleshooting.md` заполнен (минимум 2 проблемы)
- [ ] Экзамен сдан
